 ...
 * constructor args:
 * <p>
 * <b>includeSourceNames:</b> To include property sources by name, provide a list of
 * regex. If set, property sources that don't match will be excluded
 * <b>includePropertyNames:</b> To include properties by name, provide a list of regex. If
 * set, properties that don't match will be excluded
 * </p>
 *
...
public class DefaultPropertyFilter implements EncryptablePropertyFilter {
	...
	public DefaultPropertyFilter(List<String> includeSourceNames, List<String> excludeSourceNames,
			List<String> includePropertyNames, List<String> excludePropertyNames) {
