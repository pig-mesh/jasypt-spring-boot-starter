...
public @interface EncryptablePropertySource {
	...
	/**
	 * Indicate the name of this property source. If omitted, a name will be generated
	 * based on the description of the underlying resource.
	 *
	 ...
	 * {@code "classpath:/com/myco/app.properties"} or {@code "file:/path/to/file"}.
	 * <p>
	 ...
	 * registered with the {@code Environment}. See {@linkplain EncryptablePropertySource
	 * above} for examples.
	 * <p>
