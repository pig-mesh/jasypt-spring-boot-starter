...
public class JasyptEncryptorConfigurationProperties {
	...
	/**
	 * Whether to use JDK/Cglib (depending on classpath availability) proxy with an AOP
	 * advice as a decorator for existing
	 * {@link org.springframework.core.env.PropertySource} or just simply use targeted
	 * wrapper Classes. Default Value is {@code false}.
	 */
	private Boolean proxyPropertySources = false;

	/**
	 * Define a list of {@link org.springframework.core.env.PropertySource} to skip from
	 * wrapping/proxying. Properties held in classes on this list will not be eligible for
	 * decryption. Default Value is {@code empty list}.
	 */
	 ...
	 * {@link org.jasypt.encryption.StringEncryptor}. Default Value is
	 * {@code jasyptStringEncryptor}.
	 */
	...
	/**
	 * Encryption/Decryption Algorithm to be used by Jasypt. For more info on how to get
	 * available algorithms visit: <a href="http://www.jasypt.org/cli.html"/>Jasypt CLI
	 * Tools Page</a>. Default Value is {@code "PBEWITHHMACSHA512ANDAES_256"}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	 * @see com.ulisesbocchio.jasyptspringboot.encryptor.SimpleGCMStringEncryptor
	...
	/**
	 * Number of hashing iterations to obtain the signing key. Default Value is
	 * {@code "1000"}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	 * @see com.ulisesbocchio.jasyptspringboot.encryptor.SimpleGCMStringEncryptor
	...
	/**
	 * The name of the {@link java.security.Provider} implementation to be used by the
	 * encryptor for obtaining the encryption algorithm. Default Value is {@code null}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	...
	/**
	 * The class name of the {@link java.security.Provider} implementation to be used by
	 * the encryptor for obtaining the encryption algorithm. Default Value is
	 * {@code null}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	...
	/**
	 * A {@link org.jasypt.iv.IvGenerator} implementation to be used by the encryptor.
	 * Default Value is {@code "org.jasypt.iv.RandomIvGenerator"}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	...
	/**
	 * Specify the form in which String output will be encoded. {@code "base64"} or
	 * {@code "hexadecimal"}. Default Value is {@code "base64"}.
	 *
	 * @see org.jasypt.encryption.pbe.PBEStringEncryptor
	...
	/**
	 * Specify a PEM/DER base64 encoded string. PEM encoded keys can simply omit the
	 * "BEGIN/END PRIVATE KEY" header/footer and just specify the base64 encoded key. This
	 * property takes precedence over {@link #setPrivateKeyLocation(String)}
	 *
	...
	/**
	 * Specify a PEM/DER base64 encoded string. PEM encoded keys can simply omit the
	 * "BEGIN/END PUBLIC KEY" header/footer and just specify the base64 encoded key. This
	 * property takes precedence over {@link #setPrivateKeyLocation(String)}
	 *
	 * @see com.ulisesbocchio.jasyptspringboot.encryptor.SimpleAsymmetricStringEncryptor
	...
	/**
	 * Specify a PEM/DER public key location, in Spring's resource nomenclature (i.e.
	 * classpath:resource/path or file://path/to/file)
	 *
	 * @see com.ulisesbocchio.jasyptspringboot.encryptor.SimpleAsymmetricStringEncryptor
	...
	/**
	 * Specify a salt base64 String when using GCM encryption when used with master
	 * password
	 *
	 * @see com.ulisesbocchio.jasyptspringboot.encryptor.SimpleGCMStringEncryptor
	...
	/**
	 * Specify the class names of extra
	 * {@link org.springframework.context.ApplicationEvent} events that should trigger a
	 * property cache refresh.
	...
	public static class PropertyConfigurationProperties {
		 ...
		 * {@link com.ulisesbocchio.jasyptspringboot.EncryptablePropertyDetector}. Default
		 * value is {@code "encryptablePropertyDetector"}
		 */
		private String detectorBean = "encryptablePropertyDetector";

		/**
		 * Specify the name of the bean to be provided for a custom
		 * {@link com.ulisesbocchio.jasyptspringboot.EncryptablePropertyResolver}. Default
		 * value is {@code "encryptablePropertyResolver"}
		 */
		private String resolverBean = "encryptablePropertyResolver";

		/**
		 * Specify the name of the bean to be provided for a custom
		 * {@link EncryptablePropertyFilter}. Default value is
		...
		public static class FilterConfigurationProperties {
			...
			/**
			 * Specify the property name patterns to be included for decryption
			 * by{@link EncryptablePropertyFilter}. Default value is {@code null}
			 */
			private List<String> includeNames = null;

			/**
			 * Specify the property name patterns to be EXCLUDED for decryption
			 * by{@link EncryptablePropertyFilter}. Default value is
			 * {@code jasypt\\.encryptor\\.*}
			 */
