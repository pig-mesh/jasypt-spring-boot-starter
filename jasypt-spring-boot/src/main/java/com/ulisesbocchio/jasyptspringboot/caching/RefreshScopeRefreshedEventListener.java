...
public class RefreshScopeRefreshedEventListener
		implements ApplicationListener<ApplicationEvent>, InitializingBean, Ordered {
	...
	public RefreshScopeRefreshedEventListener(ConfigurableEnvironment environment,
			EncryptablePropertySourceConverter converter, JasyptEncryptorConfigurationProperties config) {
	...
	public void afterPropertiesSet() throws Exception {
		Stream.concat(EVENT_CLASS_NAMES.stream(), this.config.getRefreshedEventClasses().stream())
