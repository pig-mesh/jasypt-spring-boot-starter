...
/**
 * <p>
 * Configuration class that registers a {@link BeanFactoryPostProcessor} that wraps all
 * {@link PropertySource} defined in the {@link Environment} with
 * {@link com.ulisesbocchio.jasyptspringboot.wrapper.EncryptablePropertySourceWrapper} and
 * defines a default {@link StringEncryptor} for decrypting properties that can be
 * configured through the same properties it wraps.
 * </p>
 * <p>
 * The {@link StringEncryptor} bean is only defined when no other bean of type
 * {@link StringEncryptor} is present in the Application Context, thus allowing for custom
...
public class EnableEncryptablePropertiesConfiguration {
	...
	public static EnableEncryptablePropertiesBeanFactoryPostProcessor enableEncryptablePropertySourcesPostProcessor(
			final ConfigurableEnvironment environment, EncryptablePropertySourceConverter converter) {
