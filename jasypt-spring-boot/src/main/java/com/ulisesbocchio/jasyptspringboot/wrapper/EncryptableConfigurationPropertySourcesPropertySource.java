...
public class EncryptableConfigurationPropertySourcesPropertySource
	...
	public EncryptableConfigurationPropertySourcesPropertySource(
			PropertySource<Iterable<ConfigurationPropertySource>> delegate) {
		super(delegate.getName(),
				Iterables.filter(delegate.getSource(),
						configurationPropertySource -> !configurationPropertySource.getUnderlyingSource().getClass()
								.equals(EncryptableConfigurationPropertySourcesPropertySource.class)));
	...
	private ConfigurationProperty findConfigurationProperty(String name) {
		try {
			...
			// simulate non-exposed version of ConfigurationPropertyName.of(name,
			// nullIfInvalid)
	...
	private ConfigurationProperty findConfigurationProperty(ConfigurationPropertyName name) {
		...
		for (ConfigurationPropertySource configurationPropertySource : getSource()) {
			if (!configurationPropertySource.getUnderlyingSource().getClass()
					.equals(EncryptableConfigurationPropertySourcesPropertySource.class)) {
