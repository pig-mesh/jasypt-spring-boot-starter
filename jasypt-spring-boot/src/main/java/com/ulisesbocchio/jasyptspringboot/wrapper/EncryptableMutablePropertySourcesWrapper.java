...
public class EncryptableMutablePropertySourcesWrapper extends MutablePropertySources {
	...
	public EncryptableMutablePropertySourcesWrapper(PropertySources propertySources,
			EncryptablePropertySourceConverter propertyConverter, EnvCopy envCopy) {
	...
	public EncryptableMutablePropertySourcesWrapper(EncryptablePropertySourceConverter propertyConverter,
			EnvCopy envCopy) {
		super();
