...
/**
 * <p>
 * Wrapper for {@link PropertySource} instances that simply delegates the
 * {@link #getProperty} method to the {@link PropertySource} delegate instance to retrieve
 * properties, while checking if the resulting property is encrypted or not using the
 * Jasypt convention of surrounding encrypted values with "ENC()".
 * </p>
 * <p>
 * When an encrypted property is detected, it is decrypted using the provided
